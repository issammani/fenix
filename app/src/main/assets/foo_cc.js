import {
  ...
  map,
  range,
} from "https://appassets.androidplatform.net/assets/foo_lit.js";

const cardImgMap = {
  visa: "https://appassets.androidplatform.net/assets/vcard.png",
  mastercard: "https://appassets.androidplatform.net/assets/mcard.png",
};
...
class App extends LitElement {
  ...
  constructor() {
    ...
    window.addEventListener("message", (ev) => {
      alert("ping");
      this.credentials = JSON.parse(ev.data);
    });
  }
